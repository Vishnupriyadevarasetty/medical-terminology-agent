MEDICAL_KNOWLEDGE = {
    ...
    "mri": {
        "category": "Medical Abbreviation",
        "description": (
            "MRI stands for Magnetic Resonance Imaging, which creates detailed "
    ...
    "ct scan": {
        ...
        "description": (
            "A CT scan combines X-rays and computer technology to create "
    ...
    "x-ray": {
        "category": "Medical Procedure",
        "description": (
            "An X-ray is an imaging technique commonly used to examine bones "
            "and internal organs."
        ),
    },
    "biopsy": {
        "category": "Medical Procedure",
        "description": (
            "A biopsy removes a small tissue sample for laboratory examination."
        ),
    },
}